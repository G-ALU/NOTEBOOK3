...
let AppComponent = (() => {
    let _classDecorators = [(0, core_1.Component)({
            selector: 'app-root',
            standalone: true,
            imports: [router_1.RouterOutlet, landingpage_component_1.LandingpageComponent, loginpage_component_1.LoginpageComponent, register_component_1.RegisterComponent, userdashboard_component_1.UserdashboardComponent],
