...
const userdashboard_component_1 = require("../userdashboard/userdashboard.component");
let LoginpageComponent = (() => {
    let _classDecorators = [(0, core_1.Component)({
            selector: 'app-loginpage',
            standalone: true,
            imports: [navbar_component_1.NavbarComponent, router_1.RouterLink, register_component_1.RegisterComponent, userdashboard_component_1.UserdashboardComponent, common_1.CommonModule, forms_1.ReactiveFormsModule],
